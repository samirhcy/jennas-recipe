...
// aboutPage
// Jenna's Recipedia - About Page Recipes API

(function () {
  document.addEventListener("DOMContentLoaded", () => {
    const apiKey = "9b11bc4e20ba49f484a7d2740b8650c7";
    ...
    async function loadRecipes() {
      try {
        ...
        const url = `https://api.spoonacular.com/recipes/complexSearch?query=pasta&number=3&addRecipeInformation=true&apiKey=${apiKey}`;
        ...
        if (!data.results || data.results.length === 0) {
          recipeContainer.innerHTML = `
            <div class="col-12 text-center text-warning fw-bold">
              No recipes found.
            </div>
          `;
          return;
        ...
        data.results.forEach(recipe => {
          const summary = recipe.summary
            ? recipe.summary.replace(/<[^>]*>/g, "").substring(0, 140)
            : "Delicious recipe you will love!";
